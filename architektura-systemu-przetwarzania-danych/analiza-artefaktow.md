...
W trakcie tworzenia systemu potrzebowałem narzędzia umożliwiającego dostęp do artefaktów w celu przeprowadzenia testów integracyjnych. W celu weryfikacji poprawności musiałem porównać wyniki przetwarzania na różnych etapach. Na Rys. 28 przedstawiono kompletny przepływ danych uwzględniający rolę narzędzia xtrdb.

<figure><img src="../assets/przeplyw_danych_analiza_artefaktow.png" width="100%" alt=""><figcaption><p>Rys. 28. Przepływ danych w analizie artefaktów</p></figcaption></figure>
