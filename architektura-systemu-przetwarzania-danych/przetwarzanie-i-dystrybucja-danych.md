...
W przypadku rozpoczęcia procesu przetwarzania danych analizując przedstawiony na Rys. 9 można wydzielić następujący schemat przepływu - Rys. 23:

<figure><img src="../assets/schemat_przeplywu_przetwarzanie.svg" width="100%" alt=""><figcaption><p>Rys. 23. Schemat przepływu sterowania w procesie przetwarzania</p></figcaption></figure>
...
Rzut okna na plan realizacji zapytania przedstawi obraz na Rys. 24:

<figure><img src="../assets/graf_plan_zapytania_2.png" width="100%" alt=""><figcaption><p>Rys. 24. Graficzna reprezentacja planu realizacji zapytania 2</p></figcaption></figure>
...
<figure><img src="../assets/gnuplot_dane_realtime.png" alt=""><figcaption><p>Rys. 25. Zrzut zawartości okna gnuplot przedstawiający dane napływające</p></figcaption></figure>

Na Rys. 25 widzimy to co dane przedstawiały w postaci numerycznej. Kształt piły to pierwsza kolumna, nieregularny kształt opływający kształt piły to druga kolumna. Rysunek przedstawia dane statyczne – w oknie jednak dane te napływają i rysunek jest aktualizowany na bieżąco.
...
Zapis procesu prezentowany na ekranie (Rys. 26) przedstawia się następująco:

<figure><img src="../assets/simple-record.gif" width="100%" alt=""><figcaption><p>Rys. 26. Zapis procesu przetwarzania danych w czasie rzeczywistym</p></figcaption></figure>
