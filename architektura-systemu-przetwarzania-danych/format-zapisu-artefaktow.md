---
description: Format zapisu danych wymaga uwzględnienia zależności czasowych w opracowanym systemie. Zależności te powinny oprócz zarejestrowanych danych odtworzyć kolejność ich zarejestrowania oraz występujące między nimi przerwy w transmisji.
---
# Format zapisu artefaktów

W systemie przetwarzanie są serie czasowe w postaci artefaktów, efemerydów i substratów.
Dane domyślnie zapisywane są w zwykłych plikach znajdujących się kontrolą systemu operacyjnego. Potencjalne zmiany w tym aspekcie są na etapie koncepcyjnym.
