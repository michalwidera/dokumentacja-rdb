...
Faza `extractIntermediateStreams` tworzy osobny substrat dla każdego zapytania, co daje dwa identyczne węzły pośrednie w grafie (Rys. 32):

<figure><img src="../assets/dedup_przed.svg" width="70%" alt=""><figcaption><p>Rys. 32. Graf przed deduplikacją — dwa identyczne substraty STREAM_ADD_core0_core1</p></figcaption></figure>
...
<figure><img src="../assets/dedup_po.svg" width="40%" alt=""><figcaption><p>Rys. 33. Graf po deduplikacji — jeden wspólny substrat, wygenerowany poleceniem: xretractor dedup_after.rql -c -d</p></figcaption></figure>
