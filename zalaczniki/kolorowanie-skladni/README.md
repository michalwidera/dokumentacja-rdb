...
_Rys. 64. Podświetlenie składni RQL w edytorze Visual Studio Code_
...
Widok tekstu w edytorze vim przedstawia Rys. 65.

![widok w edytorze vim](../../assets/vim-podswietlenie-rql.png)

_Rys. 65. Podświetlenie składni RQL w edytorze vim_
...
Wywołanie `bat query.rql` wyświetli zawartość pliku z numeracją linii i podświetleniem składni w terminalu, gdzie słowa kluczowe, typy, komentarze i literały łańcuchowe będą miały odrębne kolory zgodne z aktywnym motywem `bat` (Rys. 66).

<figure><img src="../../assets/batcat-polecenie-rql.png" alt="Widok polecenia batcat test.rql"><figcaption><p>Rys. 66. Podświetlenie składni RQL w terminalu - polecenie batcat</p></figcaption></figure>
