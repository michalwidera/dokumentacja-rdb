...
> **_NOTE:_** Funkcje i propagację typów sprawdzają testy integracyjne `fncall_runtime_case`, `string_field_passthrough`, `issue121_isnull`, `issue128_numeric_to_string` i `issue128_string_to_numeric` oraz testy jednostkowe `ut_compiler`, `ut_expeval` i `ut_facctxtsrc`.
