...
<figure><img src="../../.gitbook/assets/przeplyw_sterowania_adhoc.png" alt=""><figcaption><p>Rys. 32 Przepływ sterowania dla zapytań Ad Hoc</p></figcaption></figure>

Na Rys. 32 przedstawiono opisany powyżej przepływ sterowania. Plik z zapytaniami i dyrektywami najpierw jest kierowany do procesu xretractor. Następnie poprzez pamięć współdzieloną proces xqry pobiera dane z xretractor. Tym samym procesem możemy wysłać do procesu xretractor polecenie. W tym poleceniu zawieramy tekst dodatkowego zapytania, które xretractor powinien dołączyć do przetwarzanego drzewa.
