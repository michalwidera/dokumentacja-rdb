...
Przypomnijmy schemat funkcji `processRows()` opisanej w rozdziale [Algorytm przeglądu drzewa zapytań](algorytm-przegladu-drzewa-zapytan.md). Dla każdego zapytania nie będącego deklaracją wykonywane są kolejno cztery kroki (Rys. 48):
...
_Rys. 48. Kolejność kroków przetwarzania jednego zapytania_
...
_Rys. 49. Przepływ ewaluacji reguły_
...
_Rys. 50. Sekwencja zbierania danych przez DO DUMP –3 TO 2_
...
_Rys. 51. Niezależna ewaluacja wielu reguł na tym samym strumieniu_
